...
\begin{lem}
  ...
  \begin{enumerate}[(1)]
    \item Jeder Punkt aus $E$ liegt in der $\W$-Bahn eines Elementes aus  $\overline{\mathfrak{C}(\Delta)}$.
...
\begin{proof}
  ...
  Sei nun $\lambda \in E$ gegeben. 
  Wir betrachten nun die Teilmenge $M$ aller $\W$-Bahnelemente $\mu \in \W\lambda$, für die $\mu \succeq \lambda$ gilt.
