...
\begin{figure}
  ...
  \end{tikzpicture}
  \caption{Das Wurzelsystem \textbf{A2} mit den \weyl\hyp{}Kammern $\mathfrak{C}_1,\dots,\mathfrak{C}_6$ im linken Teil und mit der Fundamentalkammer $\mathfrak{C}(\Delta)$ zu $\Delta := \{\alpha, \beta\}$ im rechten Teil.}
\end{figure}
