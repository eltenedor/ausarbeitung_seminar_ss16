...
Liegen zwei reguläre Elemente $\gamma, \gamma'$ in derselben \weyl\hyp{}Kammer, so liegen sie bezüglich aller Hyperebenen $P_\alpha$ auf derselben Seite, was bedeutet, dass $\sign (\gamma, \alpha) = \sign( \gamma', \alpha)$ gilt, für alle $\alpha \in \Phi$.
...
Mit Satz \ref{thm:base} folgt für zwei reguläre Elemente $\gamma, \gamma'$ aus der Gleichheit $\Delta(\gamma) = \Delta(\gamma')$ sofort $\Phi^+(\gamma) = \Phi^+(\gamma')$, aufgrund der Basiseigenschaft von Fundamentalsystemen.
