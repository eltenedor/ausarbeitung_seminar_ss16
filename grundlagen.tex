...
\begin{bem}
  ...
  Daher ist auch die Höhenfunktion 
  \begin{displaymath}
...
\begin{proof}
  ...
  Dies bedeutet jedoch gerade, dass $\sigma(x) \in P_\alpha$ und damit wäre $\sigma(x)$ nicht regulär im Widerspruch zu (a). Es muss also auch $\mathfrak{C}(\sigma(\gamma)) = \mathfrak{C}(\sigma(\gamma'))$ gelten.
