...
\begin{lem}
  ...
  Sei $M \subseteq E$ eine Teilmenge von Vektoren und $P_\gamma$ mit $\gamma \in E$ eine Hyperebene.
...
\begin{proof}
  ...
  Aufgrund der Linearität von $\sigma_\alpha$ besitzt dann auch die Wurzel $\sigma_\alpha(\beta)$ mindestens einen positiven Linearfaktor und ist damit nach \hyperref[it:B2]{(B2)} ebenfalls positiv.
...
\begin{proof}
  ...
  \begin{align*}
    \sigma_\alpha(\delta) 
    &= \sigma_\alpha\bigg(\,\frac{1}{2} \sum_{\beta \in \Phi^+} \beta \bigg)\\
    &= \sigma_\alpha\bigg(\,\frac{1}{2} \sum_{\substack{\beta \in \Phi^+\\ \beta \neq \alpha}} \beta + \frac{1}{2}\alpha \bigg) \\
...
\begin{proof}
  ...
  Lemma \ref{lem:permute} impliziert die Gleichheit $\beta_s = \alpha_s$, da sonst andernfalls $\sigma_s(\beta_s)$ positiv sein müsste.
...
\begin{cor}
  ...
  Sei $\sigma = \sigma_1 \dots \sigma_t$ mit einfachen Spiegelungen $\sigma_i$, wobei $t$ minimal gewählt sei. Dann ist $\sigma(\alpha_t)$ eine negative Wurzel.
\end{cor}
